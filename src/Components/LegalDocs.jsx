  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          Epicize <span className="legal-siteSign"></span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Epicize, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Epicize, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Epicize is designed to simplify healthcare access. You can choose
